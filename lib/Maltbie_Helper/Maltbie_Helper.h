...
#ifndef MALTBIE_HELPER_H
#define MALTBIE_HELPER_H
...
// Use SQRT_MAX_PWM_VALUE when making a squared function lighting curve (simulate an audio taper pot from a linear pot/TOF)
    ...
    // Resolution of PWM (analogWrite)
        ...
        //#define BITS_PWM  14  // PWM resolution in bits <<< CHANGE Resolution HERE <<<< Very Smooth! :-)
...
class Maltbie_Helper {
public: 
    Maltbie_Helper(void) { m_serialPtr = &Serial; }
